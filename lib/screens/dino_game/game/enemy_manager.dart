...
import 'package:vn_template/screens/dino_game/game/enemy.dart';
...
class EnemyManager extends Component with HasGameReference<DinoRun> {
  ...
  void onMount() {
    ...
    if (_data.isEmpty) {
      ...
      _data.addAll([
        EnemyData(
          image: game.images.fromCache(DinoGameAssets.angryPig),
          nFrames: 16,
          stepTime: 0.1,
        ...
        EnemyData(
          image: game.images.fromCache(DinoGameAssets.bat),
          nFrames: 7,
          stepTime: 0.1,
        ...
        EnemyData(
          image: game.images.fromCache(DinoGameAssets.rino),
          nFrames: 6,
          stepTime: 0.09,
